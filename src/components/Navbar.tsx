      ...
      <div className="w-full bg-yellow-400 text-black overflow-x-auto whitespace-nowrap scrollbar-hide shadow-md">
        <div className="flex items-center justify-center px-4 py-2">
          <div className="flex items-center text-sm font-medium">
            ...
            <span className="font-semibold">NOTICE:</span> <span className="ml-1">Token creation is temporarily limited to ensure payment system stability. Official CA: 77pactxmNv9JZjUz2Rc5aC449i69ihwoJGhbxLUUpump. Follow our X (Twitter) for updates. Thank you for your patience.</span>
          </div>
        </div>
      </div>
