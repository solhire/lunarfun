...
export default function Footer() {
  ...
  const footerLinks: FooterLinks = {
    ...
    Resources: [
      ...
      { href: '/faq', label: 'FAQ' },
      { href: 'https://docs.lunara.fun', label: 'Documentation', external: true },
          ...
          <div className="mt-16 pt-8 border-t border-primary/10">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-6">
                ...
                <a href="https://github.com/lunara" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-all duration-300 hover:scale-110">
