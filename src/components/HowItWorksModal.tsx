            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              ...
              <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                <p className="text-red-500 text-sm font-medium flex items-center gap-2">
                  ...
                  Contract Address (CA) will be posted exclusively on our <a href="https://x.com/lunarafun" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-light transition-colors">X (Twitter) account @lunarafun</a>
                </p>
              </div>
